...
<title>Alta de Peluquería</title>
<meta
		...
		<form action="CreateLocalServlet" method="post" class="shadow p-5">
			<div class="form-group mb-4">
				<label for="name">Nombre</label> <input type="text"
					...
					placeholder="Ingrese el nombre de la peluquería" required>
			</div>
			<div class="form-group mb-4">
				<label for="coordenates">Coordenadas</label> <input type="text"
					name="coordenates" id="coordenates" class="form-control"
					placeholder="Ingrese las coordenadas geográficas" required>
			</div>
			<div class="form-group mb-4">
