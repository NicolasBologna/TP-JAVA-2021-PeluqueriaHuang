...
<body class="bg-dark text-light">
	...
	<div class="container">
		...
		<form action="CreateUserServlet" method="post" class="shadow p-5">
			...
			<div class="mb-4">
				...
				<div class="form-check form-check-inline">
				  <label class="form-check-label">
				    <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="<%=role.getId()%>"> <%=role.getRole()%>
			...
			<button name="register" id="register" class="btn btn-block login-btn"
				type="submit">
